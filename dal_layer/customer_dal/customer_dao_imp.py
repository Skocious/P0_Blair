...
class CustomerDAOImp(CustomerDAOInterface):
    # customer_id_generator = 2
    # customers_list = {}

    def __init__(self):
        customer_id_temp = Customer(1, "William", "Blair")
        self.customers_list = []
        self.customer_id_generator = 2
        self.customers_list.append(customer_id_temp)
        # self.customers_list.self[customer_id_catch]

    def create_customer(self, customer: Customer) -> Customer:
        customer.customer_id = self.customer_id_generator
        self.customer_id_generator += 1
        self.customers_list.append(customer)
        # self.customers_list[self.customer_id_generator] = customer
        return customer
    ...
    # def get_all_customers_by_id(self) -> List[Customer]:
    #   customers_list = list(CustomerDAOImp.customers_list.values())
    #  return customers_list

    def update_customer_info_by_id(self, customer: Customer) -> Customer:
        # customers_list = list(self.customers_list[customer_id])
        # return customers_list
    ...
    def delete_customer_by_id(self, customer_id) -> bool:
        ...
        # try:
        #   del CustomerDAOImp.customers_list[customer_id]
        #  return True
        # except KeyError:
        #   return False
